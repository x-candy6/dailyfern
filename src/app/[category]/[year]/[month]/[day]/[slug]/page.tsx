...
const categoryToVariant: Record<string, 1 | 2 | 3 | 4 | 5 | 6> = {
  technology: 2, business: 3, culture: 4,
  earth: 5, health: 6, news: 1,
  sport: 2, arts: 4, travel: 5,
};
            ...
            <div className="grid lg:grid-cols-3 gap-10">
              <div className="lg:col-span-2">
                <article className="petal-panel p-8 lg:p-12">
                  ...
                  <div className="prose prose-lg max-w-none" dangerouslySetInnerHTML={{ __html: htmlBody }} />
              ...
              <aside className="space-y-6">
                ...
                <div className="petal-panel p-6">
                  <h3 className="font-display font-bold text-lg mb-3">Get the brief</h3>
                  <p className="excerpt text-sm mb-4">Five stories, grounded context, zero noise.</p>
                  <form className="flex flex-col gap-2">
                    <input type="email" placeholder="your@email.com" className="newsletter-input text-sm py-2" />
                    <button type="submit" className="btn-accent text-sm">Subscribe</button>
                  </form>
                </div>

                <div className="petal-panel p-6">
                  <h3 className="font-display font-bold text-lg mb-3">More in {category?.label || article.category}</h3>
                  <Link href={`/${article.category}`} className="link-accent text-sm">
                    View all stories
