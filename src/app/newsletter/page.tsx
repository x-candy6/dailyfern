      ...
      <section className="relative min-h-[50vh] flex flex-col justify-center overflow-hidden bg-[#F9F5EC]">
        ...
        <div className="relative z-10 px-6 lg:px-12 py-20 lg:py-28">
          <div className="max-w-4xl mx-auto text-center">
            <h1 className="mb-6" style={{ fontFamily: 'var(--font-lora)', fontStyle: 'italic', fontWeight: 700, fontSize: 'clamp(2.5rem, 6vw, 5rem)', letterSpacing: '-0.02em', lineHeight: 1.05, color: '#1A2B1A' }}>The Daily Brief</h1>
            <p className="text-[#5A6E5A] text-lg lg:text-xl max-w-2xl mx-auto">
      ...
      <section className="py-12 lg:py-16 bg-[#F9F5EC]">
        <div className="px-6 lg:px-12">
          <div className="max-w-lg mx-auto">
            <div className="petal-panel p-8 lg:p-12 border-t-4 border-[#2D6A4F]">
