      ...
      <section className="relative min-h-[50vh] flex flex-col justify-center overflow-hidden bg-zinc-50">
        ...
        <div className="relative z-10 px-6 lg:px-12 py-20 lg:py-28">
          <div className="max-w-4xl mx-auto text-center">
            <h1 className="hero-headline text-[#171717] mb-6">The Daily Brief</h1>
            <p className="text-zinc-500 text-lg lg:text-xl max-w-2xl mx-auto">
      ...
      <section className="py-12 lg:py-16 bg-zinc-50">
        <div className="px-6 lg:px-12">
          <div className="max-w-lg mx-auto">
            <div className="petal-panel p-8 lg:p-12 border-t-4 border-[#16a34a]">
