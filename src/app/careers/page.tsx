      ...
      <section className="relative min-h-[40vh] flex flex-col justify-center overflow-hidden bg-zinc-50">
        ...
        <div className="relative z-10 px-6 lg:px-12 py-20 lg:py-28">
          <div className="max-w-4xl mx-auto">
            <h1 className="hero-headline text-[#171717] mb-6">Careers</h1>
            <p className="text-zinc-500 text-lg max-w-2xl">Join a small team that cares about getting it right.</p>
          </div>
        </div>
      </section>
