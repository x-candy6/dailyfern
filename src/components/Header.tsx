...
/** Site header with desktop nav and mobile menu. */
    ...
    <>
      ...
      <div className={`mobile-menu ${menuOpen ? 'open' : ''}`}>
        <div className="flex items-center justify-between mb-8">
          <span className="font-display font-black text-xl">Daily Fern</span>
          <button
        ...
        <nav className="flex flex-col gap-4">
          <Link href="/" onClick={() => setMenuOpen(false)} className="text-2xl font-display font-bold">
            Home
          </Link>
